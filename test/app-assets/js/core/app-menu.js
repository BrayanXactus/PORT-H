...
(function(window, document, $) {
  ...
  $.app.menu = {
    ...
    changeMenu: function(screen){
	  ...
	  $("#main-menu-navigation").removeAttr("data-menu");
	  $("#main-menu-navigation li a").removeAttr("data-toggle");

      if(screen == 'sm' || screen == 'xs'){
		  
		$("#main-menu-navigation").attr("data-menu", "menu-navigation");
		$("#main-menu-navigation li a").attr("data-toggle", "dropdown");
